...
const faqs = [
  ...
  {
    question: "Can I change my account role later?",
    answer:
      "Currently, account roles are permanent. You will need to create a new account to switch between User and Shop Owner.",
  },
  {
    question: "Where can I view my order history?",
    answer:
      "Log into your account and navigate to the 'Dashboard' section to view your history.",
  },
];
      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
          <div className="bg-card border border-card-border rounded-2xl p-6 flex flex-col items-center text-center hover:border-accent transition-colors">
            <h3 className="text-text-main font-bold tracking-wider mb-2">
              Live Chat
            </h3>
            <p className="text-xs text-text-sub mb-4">
              Chat with our team directly.
            </p>
            <button className="text-[10px] bg-accent/10 text-accent px-4 py-2 rounded-lg font-bold uppercase tracking-widest">
              Start Chat
            </button>
          </div>
          <div className="bg-card border border-card-border rounded-2xl p-6 flex flex-col items-center text-center hover:border-accent transition-colors">
            ...
            <Link
              href="/contact"
              className="text-[10px] bg-surface text-text-main border border-card-border px-4 py-2 rounded-lg font-bold uppercase tracking-widest hover:bg-card-border transition-colors"
            >
              Go to Contact
            </Link>
          </div>
        ...
        {/* FAQ Section */}
        <div>
          <h2 className="text-xl font-serif text-text-main mb-6 uppercase tracking-widest border-b border-card-border pb-4">
          ...
          <div className="flex flex-col gap-3">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className="bg-card border border-card-border rounded-xl overflow-hidden transition-all"
              >
                <button
